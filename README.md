...
**WARNING: Because of a conflict in the Google assertion of duplicate content the [original page](https://www.scrumpoker.online) was replaced by a non-functional version [5k.lt](http://5k.lt). I already contacted Google trying to resolve the issue. Feel free [to report it was "WebSpam"](https://www.google.com/webmasters/tools/spamreportform?hl=en) as well to remove it from the index again!**
