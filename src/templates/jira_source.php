...
<div ng-if="!master.current.loaded">
    <form role="form">
        ...
        <?php if (!$jiraConfiguration['disable_jira_fields']) { ?>
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <div class="form-group">
                        <label>JIRA base url:</label>
                        <input type="text" class="form-control" placeholder="http://jira.atlassian.net"
                               ng-model="master.current.base_url">
                    </div>
                </div>
                <div class="col-xs-12 col-md-6">
                    <div class="form-group">
                        <label>Project</label>
                        <input type="text" class="form-control" placeholder="MYPROJECT"
                               ng-model="master.current.project">
                    </div>
                </div>
            </div>
        <?php } ?>
        ...
        <div class="col-xs-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ master.current.issue.fields.creator.displayName }} created issue on {{
                    master.current.issue.fields.created.date}}
                </div>
